...
La "Pool Monitor Card" est un plugin d'Home Assistant qui fournit des informations sur la température, le pH et les niveaux d'ORP de votre piscine. 
...
| `temperature_setpoint` | nombre | **Option** | Point de consigne Temperature |`27`|
| `ph` | texte | **Option*** | Entité ph  |`aucune`|
| `ph_setpoint` | nombre | **Option** | Point de consigne pH |`7.2`|
...
*Vous devez définir au moins l'une de ces 3 entités.
