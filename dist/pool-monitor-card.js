...
`;class cardContent{static generateTitle(e){const s=e.title!==void 0?st` <h1 class="pool-monitor-title">${e.title}</h1> `:st``;return st`${s}`}static generateBody(e,s){if(!s)return st` <div class="warning-message">No sensor data available</div> `;return st`
    ...
    `}static _moreinfo(e){const s=new Event("hass-more-info",{bubbles:true,composed:true});s.detail={entityId:e};const o=document.querySelector("home-assistant");if(o)o.dispatchEvent(s)}}const kt={compact:false,show_names:true,show_labels:true,show_last_updated:false,show_icons:true,show_units:true,gradient:true,language:"en"};const St={low:"#fdcb6e",warn:"#e17055",normal:"#00b894",cool:"#00BFFF",marker:"#000000",hi_low:"#00000099"};function getDisplayConfig(){return{...kt}}function getColorConfig(){return{...St}}function getSensorConfig(e,s){if(!s[e])return{};return{...s[e]}}class MonitorCardBase extends i{static get properties(){return{hass:{},config:{}}}static styles=At;constructor(){super()}render(){const e=this.getConfig();const s=this.processData();const o=e.display.compact?cardContent.generateCompactBody:cardContent.generateBody;if(!s||Object.keys(s).length===0)return st` <div id="pool-monitor-card">
